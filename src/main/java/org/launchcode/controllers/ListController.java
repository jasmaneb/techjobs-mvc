...
public class ListController {
    ...
    public String listColumnValues(Model model, @RequestParam String column) {
        ...
        if (column.equals("all")) {
            ...
            model.addAttribute("resultsMessage", jobs.size() + " Result(s)");
            ...
            model.addAttribute("resultsMessage", items.size() + " Result(s)");
    ...
    public String listJobsByColumnAndValue(Model model,
        ...
        model.addAttribute("resultsMessage", jobs.size() + " Results(s) for " + ListController.columnChoices.get(column) + " for " + value);
        model.addAttribute("jobs", jobs);
        model.addAttribute("resultsMessage", jobs.size() + " Result(s)");
